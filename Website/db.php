      ...
      <div class="">
        <table class="w3-table w3-striped w3-white" border="2px">
          <tr>
              ...
              <th><h5>Area</h5></th>
              <th><h5>Driving License_no</h5></th>
          </tr>
          <?php 
                $con = mysqli_connect('localhost','root','');
                $select_db = mysqli_select_db($con,'auto best emporio');
                $query = "select * from `delivery person`;";
            ...
            <tr>
              ...
              <td>
              <a href="delete_db.php?id=<?php echo $db[0]; ?>" onclick="return confirm('Are you sure?')" title="delete product">
          ...
          <?php
             ...
             <tr>
                 <td colspan = 8>
                     <center>
                         <button type="button"><a href="add_deliverperson.php?msg=">Add </a></button>
                    </center>
                </td>
            </tr>
        </table>
