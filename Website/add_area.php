...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      ...
      <a href="/your_details" class="w3-bar-item w3-button"><i class="fa fa-user"></i></a>
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class=""></i>  Orders</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class=""></i>  Users</a>
  </div>
</nav>
...
<form action="add_area_action.php" method="post">
  <div class="w3-panel">
        ...
        <table class="w3-table w3-striped w3-white" border="2px">
          <tr>
            ...
            <tr>
             ...
             <tr>
                 <td colspan = 2>
                 <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure?')">Add Area</button>
