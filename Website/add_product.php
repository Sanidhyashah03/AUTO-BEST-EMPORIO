...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="Products.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="bi bi-box-seam"></i><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
        ...
        <table class="w3-table w3-striped w3-white" border="2px">
          <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="file" name="image" accept=".png,.jpg,.jpeg,.gif,.tiff,.WebP,.bmp,.svg" required>
                </td>
            </tr>
             <tr>
                 <td colspan = 2>
                 <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure?')">Add Product</button>
