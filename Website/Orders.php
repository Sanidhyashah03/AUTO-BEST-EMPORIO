...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
    ...
    <a href="orders.php" class="w3-bar-item w3-button w3-padding w3-blue"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket-fill" viewBox="0 0 16 16">
      ...
      <div class="">
        <table class="w3-table w3-striped w3-white" border="2px">
          <tr>
              ...
              <th><h5>Buyer id</h5></th>
              <th><h5>Order Quantity</h5></th>
          ...
          $query = "select * from order_table where Status='Pending';";
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="order_completed.php?oid=<?php echo $data[0]; ?>"><button type="button" class="btn btn-success" onclick="confirm('Are you sure, the order is Delivered?')">Done</button></a>      
              </td>
            </tr>
            <?php }
            } ?>
