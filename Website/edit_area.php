...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="Area.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bullseye fa-fw"></i>  Area</a>
...
<form action="edit_area_action.php?areaName=<?php echo $_GET['area_name'] ?>" method="post">
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="">
        <table class="w3-table w3-striped w3-white" border="2px">
          <tr>
              <th><h5>Area Name</h5></th>
              <th><h5>Pincode</h5></th>
          </tr>
          <?php 
            ...
            <tr>
              <td>
                <input type="text" name="area_name" value="<?php echo $area[0]; ?>">
              </td>
              <td>
              <input type="tel" name="pincode" value="<?php echo $area[1]; ?>">
              </td>
            </tr>
          <?php
                }
             ...
             <tr>
                 <td colspan = 2>
                 <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure?')">Save Changes</button>
                 <button type="button" class="btn btn-danger" onclick="window.location.href = 'Area.php';">Cancel</button>
                </td>
            </tr>
        </table>
      </div>
