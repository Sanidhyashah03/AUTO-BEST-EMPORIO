        ...
        <table class="w3-table w3-striped w3-white" border="2px">
          ...
          <?php 
            ...
            <tr>
              ...
              <td>
              <a href="delete_product.php?id=<?php echo $product[0]; ?>" onclick="return confirm('Are you sure?')" title="delete product">
          ...
          <?php
             ...
             <tr>
                 <td colspan = 7>
                     <center>
                         <button type="button"><a href="add_product.php">Add Product</a></button>
                    </center>
                </td>
            </tr>
        </table>
