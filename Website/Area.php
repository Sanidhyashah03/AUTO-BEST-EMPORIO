        ...
        <table class="w3-table w3-striped w3-white" border="2px">
          ...
          <?php 
            ...
            <tr>
              ...
              <td>
                <a href="remove_area.php?area_name=<?php echo $area[0] ?>" title="Remove Area" onclick="return confirm('Are you sure?')"> 
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="edit_area?area_name=<?php echo $area[0] ?>" title="Edit Area">
          ...
          <?php
             ...
             <tr>
                 <td colspan = 3>
                     <center>
                         <button type="button"><a href="add_area.php">Add Area</a></button>
                    </center>
                </td>
            </tr>
        </table>
